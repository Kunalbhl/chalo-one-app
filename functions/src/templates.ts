export const Templates = {
  layout: (content: string, title: string) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
`,
  ...
  welcomeEmail: (name: string) => Templates.layout(`
  ...
  verifyEmail: (name: string, link: string) => Templates.layout(`
  ...
  passwordReset: (name: string, link: string) => Templates.layout(`
  ...
  walletCredited: (name: string, amount: number, newBalance: number) => Templates.layout(`
  ...
  walletDebited: (name: string, amount: number, newBalance: number, reason: string) => Templates.layout(`
  ...
  bookingConfirmation: (name: string, details: any) => Templates.layout(`
  ...
  adminAlert: (title: string, details: any) => Templates.layout(`
...
${JSON.stringify(details, null, 2)}
  ...
  accountDeleted: (name: string) => Templates.layout(`
